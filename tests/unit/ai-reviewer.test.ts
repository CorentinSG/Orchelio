...
const CONFLICTED: MatterAnalysisInput = {
  ...
  fields: {
    ...
    immigration_objective: "Renouvellement du titre.",
    ...
    petitioner: "Test Systems SAS",
    employer: "Test Systems SAS",
    prior_removals: false,
    criminal_history_disclosed: false,
  },
  intake: { date_entree_declaree: "11 février 2024" },
  documents: [
    {
      filename: "titre-sejour-entree-2024-03-04.pdf",
      category: "residence_permit",
      receivedAt: "2026-07-01T00:00:00.000Z",
      verified: false,
    },
    {
      filename: "passeport-test.pdf",
      category: "passport",
      receivedAt: "2026-07-01T00:00:00.000Z",
      verified: true,
    },
    {
      filename: "promesse-embauche.pdf",
