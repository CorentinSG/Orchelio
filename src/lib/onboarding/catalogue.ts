...
export const AI_FEATURE_OPTIONS: readonly AiFeatureOption[] = [
  {
    ...
    description: "A factual summary of what a document contains.",
    key: { default: "document_summary" },
  },
  {
    id: "entity_extraction",
    label: "Extract names and dates",
    description: "Pull out the people, organisations and dates mentioned.",
    key: { default: "entity_extraction" },
  },
  {
    id: "timeline",
    label: "Create a factual timeline",
    description: "Order the events, with the source of every date.",
    key: {
      default: "timeline",
  ...
  },
  {
    ...
    description: "List what is absent and why it matters.",
    key: { default: "missing_documents" },
  },
  {
    id: "inconsistency_detection",
    label: "Detect inconsistencies",
    description: "Flag statements that contradict each other.",
    key: { default: "inconsistency_detection" },
  },
  {
    id: "consultation_questions",
    label: "Prepare consultation questions",
    description: "Questions to ask the client at the first meeting.",
    key: { default: "consultation_questions" },
  },
  {
    id: "interview_questions",
    label: "Prepare interview questions",
    description: "Questions for interviewing a client or a witness.",
    key: { default: "interview_questions" },
  },
  {
    id: "email_drafts",
    label: "Prepare email drafts",
    description: "Drafts only. Orchelio never sends anything.",
    key: { default: "email_drafts" },
  },
  {
    id: "memo_drafts",
    label: "Prepare memo drafts",
    description: "Internal memoranda for attorney review.",
    key: { default: "memo_drafts" },
  },
  {
    id: "task_suggestions",
    label: "Suggest task lists",
    description: "Propose next steps for a matter.",
    key: { default: "task_suggestions" },
  },
  {
    id: "closing_summaries",
    label: "Prepare closing summaries",
    description: "Summarise a matter as it closes.",
    key: { default: "closing_summaries" },
  },
  {
    id: "time_entries",
    label: "Suggest time entries",
    description: "Propose time entries from recorded activity.",
    key: { default: "time_entries" },
  },
  {
    id: "document_comparison",
    label: "Compare two documents",
    description: "Show what differs between two versions.",
    key: { default: "document_comparison" },
  },
  {
    id: "independent_review",
    label: "Review another AI-generated analysis",
    description: "Claude Reviewer checks Claude Analyst's work independently.",
