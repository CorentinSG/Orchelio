...
const IMMIGRATION_STATUSES = [
  ...
  { value: "f1", label: "Étudiant F-1" },
  { value: "h1b", label: "H-1B" },
  { value: "l1", label: "L-1" },
  { value: "b2", label: "Visiteur B-2" },
  { value: "tps", label: "Statut de protection temporaire (TPS)" },
  { value: "asylum_pending", label: "Demande d’asile en cours" },
  { value: "permanent_resident", label: "Résident permanent" },
  { value: "out_of_status", label: "Hors statut" },
...
export const IMMIGRATION_FIELDS: readonly MatterField[] = [
  ...
  },
  {
    ...
    label: "Date d’expiration du statut",
    type: "date",
    section: "Statut",
    help: "Jamais traitée comme une échéance tant qu’un avocat ne l’a pas confirmée.",
  },
  { key: "immigration_objective", label: "Objectif d’immigration", type: "textarea", section: "Statut" },
  ...
  { key: "i94_available", label: "I-94 disponible", type: "boolean", section: "Entrée" },
  { key: "last_entry_date", label: "Date de dernière entrée", type: "date", section: "Entrée" },
  {
    key: "last_entry_classification",
    label: "Classification de la dernière entrée",
    type: "text",
    section: "Entrée",
    help: "Telle qu’imprimée sur l’I-94, s’il a été fourni.",
  },
  {
    key: "petitioner",
    label: "Pétitionnaire",
  ...
  { key: "prior_removals", label: "Éloignements antérieurs", type: "boolean", section: "Historique" },
  {
...
export const EMPLOYMENT_FIELDS: readonly MatterField[] = [
  ...
  {
    key: "exempt_status",
    label: "Exempté ou non exempté",
    type: "select",
    section: "Paie et heures",
    options: [
      { value: "unknown", label: "Inconnu — à déterminer par un avocat" },
      { value: "exempt", label: "Déclaré exempté" },
      { value: "non_exempt", label: "Déclaré non exempté" },
    ],
  ...
  { key: "agency_charge_filed", label: "Plainte déposée à l’agence", type: "boolean", section: "Agence" },
  { key: "agency_filing_date", label: "Date du dépôt à l’agence", type: "date", section: "Agence" },
  { key: "right_to_sue_notice", label: "Avis de droit d’agir reçu", type: "boolean", section: "Agence" },
  {
